package com.pmdiss.common.util;
...
/**
 * @author
 * @Date Created in 13:42  2018/3/5
 * @Modified by: 验证工具类
 */
...
public class Validation {
    ...
    * 匹配字符串是由  英文字母和数字组成
    */
    public static final String STR_ENG_NUM_ALL="^(?=.*[0-9])(?=.*[a-zA-Z])([a-zA-Z0-9]{6,20})$";
    /**
...
//  //------------------验证方法
    ...
    /**
    * @Description:    匹配字符串是由英文字母和数字组成
    * @Author:         yrc
    * @CreateDate:     2019/1/15 11:04
    */
    public static boolean isSTR_ENG_NUM_ALL(String str){
        return Regular(str,STR_ENG_NUM_ALL) ;
    }
    /**
    ...
    public static boolean checkUsername(String name){
        ...
        Matcher matcher = compile.matcher(name.substring(0,1));
        boolean matches = matcher.matches();
        boolean b = name.length() <= 20;
        boolean b1 = name.length() >= 6;
        boolean eng_num = isENG_NUM(name);
        if((name.length())<= 20 && (name.length() >= 6)
                && matches && isENG_NUM_(name)){
            flag=true;
            return flag;
        }
        return flag;
    }
    public static boolean checkUsername1(String name){
        boolean flag = false;
        Pattern compile = Pattern.compile("[a-zA-Z]+");
        Matcher matcher = compile.matcher(name.substring(0,1));
        boolean matches = matcher.matches();
        if( matches && isENG_NUM_(name)){
            flag=true;
            return flag;
        }
        return flag;
    ...
    public static void main(String[] args) {
        int length = "eeee2512515Zdd15425d".length();
        boolean mobileByFormat = checkUsername("eeee2512515Zdd15425d");
    }
}